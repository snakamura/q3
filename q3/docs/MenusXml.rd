...
静的なアイテムは定義時に決まっているアイテムで、text属性、action属性、param属性を使って指定します。text属性には表示する文字列を指定します。action属性にはそのアイテムが選択されたときに実行される((<アクション|URL:Action.html>))を指定します。param属性には必要があればアクションに渡す引数を指定します。
