...
エクスプローラなどからファイルをドロップすると、ドロップされたファイルをインポートします。ドロップされたファイルにはメッセージが((<"message/rfc822形式"|URL:http://www.ietf.org/rfc/rfc2046.txt>))で一通含まれるとして扱われます。Altキーを押しながらドロップすると、ドロップしたファイルをインポートするための[読み込み]ダイアログが開きます。[読み込み]ダイアログについては、((<FileImportアクション|URL:FileImportAction.html>))を参照してください。
