...
public:
	enum Flag {
		FLAG_RELOADFOLDER			= 0x00000001,
		FLAG_RELOADLIST				= 0x00000002,
		FLAG_RELOADMESSAGE			= 0x00000004,
		FLAG_RELOADPREVIEW			= 0x00000008,
		FLAG_RELOADEDIT				= 0x00000010,
		FLAG_RELOADTAB				= 0x00000020,
		FLAG_RELOADADDRESSBOOK		= 0x00000040,
		FLAG_RELOADSECURITY			= 0x00000080,
