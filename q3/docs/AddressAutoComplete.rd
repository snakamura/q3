...
アドレス帳に登録されていないメールアドレスにメールを送信すると、そのアドレスが記憶され、次回の自動補完時に候補として使用されます。デフォルトでは最新10件のアドレスが記憶されます。記憶するアドレスの個数は((<qmail.xml|URL:QmailXml.html>))のRecentAddress/Maxで指定できます。
