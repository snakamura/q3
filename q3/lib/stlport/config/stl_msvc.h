...
#   elif defined(ARMV4I)
#       define _STLP_NATIVE_HEADER(x) <../Armv4i/##x>
#       define _STLP_NATIVE_C_HEADER(x) <../Armv4i/##x>
#       define _STLP_NATIVE_CPP_C_HEADER(x) <../Armv4i/##x>
#       define _STLP_NATIVE_OLD_STREAMS_HEADER(x) <../Armv4i/##x>
#       define _STLP_NATIVE_CPP_RUNTIME_HEADER(header) <../Armv4i/##header>
#   elif defined(_ARM_)
