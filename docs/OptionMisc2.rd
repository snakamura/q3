...
メッセージを転送するときに、元のメッセージを((<"message/rfc822形式"|URL:http://www.ietf.org/rfc/rfc2046.txt>))で添付するかどうかを指定します。message/rfc822形式を使用しない場合には、本文中に転送するメッセージの内容が含まれます。デフォルトではmessage/rfc822形式を使用しません。
