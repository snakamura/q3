...
エクスプローラなどからファイルをドロップすると、ドロップされたファイルをインポートします。ドロップされたファイルにはメッセージが((<"message/rfc822形式"|URL:http://www.ietf.org/rfc/rfc2046.txt>))で一通含まれるとして扱われます。Altキーを押しながらドロップすると、ドロップしたファイルをインポートするための((<[読み込み]ダイアログ|URL:ImportDialog.html>))が開きます。
