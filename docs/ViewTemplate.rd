...
デフォルトでは表示用のテンプレートは含まれていませんが、「view_」から始まるファイル名でテンプレートを作成すると[表示]-[テンプレート]メニューの下にリストされます。たとえば、create_Test.templateというファイル名でテンプレートを作成すると、[表示]-[テンプレート]-[Test]として表示されます。
