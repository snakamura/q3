...
:生メッセージモード
  生のメッセージをヘッダも含めて表示します。ただし、テキストパートに関してはデコードした上でテキストとして表示します。ソースモードと排他です。((<[表示]-[モード]-[すべて表示]|URL:ViewRawModeAction.html>))で変更します。

:ソースモード
  メッセージのソースを表示します。テキストパートなどもデコードせずに表示します。生メッセージモードと排他です。((<[表示]-[モード]-[ソース表示]|URL:ViewSourceModeAction.html>))で変更します。
