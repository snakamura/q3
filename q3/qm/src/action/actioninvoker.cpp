...
struct ActionNameMap
{
	...
	{ L"EditDeleteBackwardChar",		IDM_EDIT_DELETEBACKWARDCHAR,			},
	{ L"EditDeleteBackwardWord",		IDM_EDIT_DELETEBACKWARDWORD,			},
	...
	{ L"MessageCreateFromFile",			IDM_MESSAGE_CREATEFROMFILE				},
	...
	{ L"MessageDraftFromFrom",			IDM_MESSAGE_DRAFTFROMFILE				},
	...
	{ L"TabSelect0",					IDM_TAB_SELECT							},
	{ L"TabSelect1",					IDM_TAB_SELECT + 1						},
	{ L"TabSelect2",					IDM_TAB_SELECT + 2						},
	{ L"TabSelect3",					IDM_TAB_SELECT + 3						},
	{ L"TabSelect4",					IDM_TAB_SELECT + 4						},
	{ L"TabSelect5",					IDM_TAB_SELECT + 5						},
	{ L"TabSelect6",					IDM_TAB_SELECT + 6						},
	{ L"TabSelect7",					IDM_TAB_SELECT + 7						},
	{ L"TabSelect8",					IDM_TAB_SELECT + 8						},
	...
	{ L"ToolInsertText0",				IDM_TOOL_INSERTTEXT						},
	{ L"ToolInsertText1",				IDM_TOOL_INSERTTEXT + 1					},
	{ L"ToolInsertText2",				IDM_TOOL_INSERTTEXT + 2					},
	{ L"ToolInsertText3",				IDM_TOOL_INSERTTEXT + 3					},
	{ L"ToolInsertText4",				IDM_TOOL_INSERTTEXT + 4					},
	{ L"ToolInsertText5",				IDM_TOOL_INSERTTEXT + 5					},
	{ L"ToolInsertText6",				IDM_TOOL_INSERTTEXT + 6					},
	{ L"ToolInsertText7",				IDM_TOOL_INSERTTEXT + 7					},
	{ L"ToolInsertText8",				IDM_TOOL_INSERTTEXT + 8					},
	{ L"ToolInsertText9",				IDM_TOOL_INSERTTEXT + 9					},
