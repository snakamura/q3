...
==QMAIL3とは
QMAIL3は、WindowsおよびWindows CE系のOSで動作するメーラです。以下のような特徴があります。
...
==ニュース
*2010/8/28 - 3.0.9をリリースしました。
*2009/5/13 - 3.0.8をリリースしました。
*2008/12/28 - 3.0.7をリリースしました。
*2008/10/31 - 3.0.6をリリースしました。
*2008/6/14 - 3.0.5をリリースしました。
*2008/3/5 - 3.0.4をリリースしました。
*2008/1/12 - 3.0.3をリリースしました。
*2007/10/31 - ((<ソースコード|URL:source.html>))を公開しました。
*2007/10/25 - 3.0.2をリリースしました。

==((<ダウンロード|URL:download.html>))

==((<リリースノート|URL:releasenotes.html>))
...
==連絡先
作者に個別に連絡を取りたい場合には、<snak at snak dot org>までメールを送ってください。
