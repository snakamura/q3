...
VS6DIR					= $(PROGRAMFILES)/Microsoft Visual Studio
VC6DIR					= $(VS6DIR)/VC98
VS7DIR					= $(PROGRAMFILES)/Microsoft Visual Studio .NET 2003
VC7DIR					= $(VS7DIR)/Vc7
VS8DIR					= $(PROGRAMFILES)/Microsoft Visual Studio 8
VC8DIR					= $(VS8DIR)/VC
VS9DIR					= $(PROGRAMFILES)/Microsoft Visual Studio 9.0
VC9DIR					= $(VS9DIR)/VC
VCVER					= 8
EVC3DIR					= $(PROGRAMFILES)/Microsoft eMbedded Tools/EVC
EVC4DIR					= $(PROGRAMFILES)/Microsoft eMbedded C++ 4.0/EVC
EVCVER					= 4
PLATFORMSDKDIR			= C:/Program Files/Microsoft SDKs/Windows/v6.1
OLDPLATFORMSDKDIR		= $(PROGRAMFILES)/Microsoft Platform SDK for Windows Server 2003 R2
CESDKWM6PRODIR			= $(PROGRAMFILES)/Windows Mobile 6 SDK/PocketPC
CESDKWM6STDDIR			= $(PROGRAMFILES)/Windows Mobile 6 SDK/Smartphone
CESDKWM5JADIR			= $(PROGRAMFILES)/Windows CE Tools/wce500/Windows Mobile 5.0 Pocket PC SDK
CESDKWM5ENDIR			= $(PROGRAMFILES)/Windows CE Tools/wce500/Windows Mobile 5.0 Pocket PC SDK
CESDKPPC2003JADIR		= $(PROGRAMFILES)/Windows CE Tools/wce420/POCKET PC 2003
CESDKPPC2003ENDIR		= $(PROGRAMFILES)/Windows CE Tools/wce420/POCKET PC 2003
CESDKSIGIIIDIR			= $(PROGRAMFILES)/Windows CE Tools/wce410/sigmarionIII SDK
CESDKPPC2002JADIR		= $(PROGRAMFILES)/Windows CE Tools/wce300/Pocket PC 2002
CESDKPPC2002ENDIR		= $(PROGRAMFILES)/Windows CE Tools/wce300/Pocket PC 2002
CESDKHPC2000JADIR		= $(PROGRAMFILES)/Windows CE Tools/wce300/hpc2000
CESDKHPC2000ENDIR		= $(PROGRAMFILES)/Windows CE Tools/wce300/hpc2000
CESDKPPCJADIR			= $(PROGRAMFILES)/Windows CE Tools/wce300/MS Pocket PC
CESDKPPCENDIR			= $(PROGRAMFILES)/Windows CE Tools/wce300/MS Pocket PC
CESDKHPCPROJADIR		= $(PROGRAMFILES)/Windows CE Tools/wce211/MS HPC Pro
CESDKHPCPROENDIR		= $(PROGRAMFILES)/Windows CE Tools/wce211/MS HPC Pro
SVNDIR					= $(PROGRAMFILES)/Subversion
...
ifeq ($(PLATFORM),win)
	LIBS				+= $(STLPORTDIR)/lib/win/$(EXLIBCPU)/stlport$(DSUFFIX).5.2.lib
else
	LIBS				+= $(STLPORTDIR)/lib/wce/$(EXLIBCPU)/stlport$(DSUFFIX).5.2.lib
endif
